...
> الهدف من الـ Section ده: هتتعرف على أهم بروتوكولات إدارة ومراقبة الشبكة (ICMP, SNMP, POP3, IMAP, Telnet, SSH) اللي مش بتنقل بيانات المستخدم لكنها أساسية لتشغيل ومراقبة الشبكة، وهتفهم ليه بعضها (زي Telnet) بقى خطر أمني حقيقي لازم يتستبدل فورًا.
