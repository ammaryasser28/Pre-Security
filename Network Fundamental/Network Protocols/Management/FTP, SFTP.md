...
> Section هتفهم إزاي FTP بينقل الملفات باستخدام اتصالين منفصلين (Control وData)، وليه استخدامه أصبح خطر أمني حقيقي بسبب غياب التشفير بالكامل، وإزاي SFTP بيحل المشكلة دي عن طريق نفق SSH مشفر بالكامل.
