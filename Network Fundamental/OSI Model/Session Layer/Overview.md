...
>  هتفهم إزاي الـ Session Layer بتدير "المحادثة" بين جهازين من أول ما تتفتح لحد ما تتقفل، إزاي بتستخدم Checkpoints عشان متضيعش البيانات لو الاتصال اتقطع، وهتقدر تربط ده بمخاطر حقيقية زي Session Hijacking وسرقة الـ Cookies.
