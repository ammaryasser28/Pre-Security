...
> هتفهم إزاي Linux بينظم كل ملفاته تحت مجلد واحد أساسي (`/`)، وهتحفظ وظيفة كل مجلد رئيسي، وهتقدر تربط ده بمعرفة أماكن الأدلة الجنائية (Forensic Artifacts) المهمة زي الـ Logs وملفات الإعدادات وقت أي تحقيق على جهاز Linux.
