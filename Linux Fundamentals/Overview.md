...
> الهدف من الـ Section ده: هتاخد نظرة شاملة عن نظام تشغيل Linux، إزاي بنيته (Architecture) شغالة، أشهر التوزيعات (Distributions) ومنها Kali Linux المخصصة للأمن السيبراني، وهتفهم ليه إتقان Linux مش اختياري بالنسبة لأي SOC Analyst لأن معظم السيرفرات في العالم شغالة بيه.
