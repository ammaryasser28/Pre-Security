...
> هتتقن أهم أوامر التنقل والتعامل مع الملفات في Linux (pwd, ls, cd, mkdir, cp, mv, touch)، وهتفهم إزاي بعض الأوامر البسيطة دي (زي touch) ممكن تتستخدم من المهاجمين لإخفاء آثارهم، وإزاي تكتشف كده كـ SOC Analyst.
